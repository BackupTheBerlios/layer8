...
namespace Layer8_CSW
{
	...
	public class MainFrame : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// button_Übernehmen
			// 
			this.button_Übernehmen.Location = new System.Drawing.Point(328, 144);
...
public class Position
{
	...
	public Position ()
	{
		...
		m_EPreis=10.15m;
		m_GPreis=200.90m; // also Fläche*ePreis - brauchen wir wahrscheinlich gar nicht wirklich
